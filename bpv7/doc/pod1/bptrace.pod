...
I<class_of_service> is I<custody-requested>[.I<priority>[.I<ordinal>[.I<unreliable>[.I<critical>[.I<data-label>[.I<ipt-report-requested>]]]]]],
...
(Boolean), I<data-label> may be any unsigned integer, and
I<ipt-report-requested> must also be 0 or 1 (Boolean).  I<custody-requested>
...
Setting I<ipt-report-requested> causes an inter-regional forwarding path
trace report to be sent to the report-to endpoint.
