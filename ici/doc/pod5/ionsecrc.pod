...
=item B<a pubkey> I<node_number> I<effective_time> I<assertion_time> I<key_length> I<key_text>
...
=item B<d pubkey> I<node_number> I<effective_time>

The B<delete public key> command.  This command deletes the public key for
I<node_number> that is identified by I<effective_time>, a count of seconds
