/*
 	ipplsa.h:	common definitions for link service
			adapter modules for GRO/GSO and IP parcels.

	Author: Fred Templin, Boeing Corp.

	Adapted from udplsa.h.
...
extern void			*ipplsa_handle_datagrams(void *parm);
